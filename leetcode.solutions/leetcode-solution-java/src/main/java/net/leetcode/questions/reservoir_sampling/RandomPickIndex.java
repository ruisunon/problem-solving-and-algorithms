package net.leetcode.questions.reservoir_sampling;
 ...
 *
 * <p>Note: The array size can be very large. Q0169_majority_element that uses too much extra space will not pass
 * the judge.
 *
 * <p>Example:
 *
 * <p>int[] nums = new int[] {1,2,3,3,3}; Q0169_majority_element solution = new Q0169_majority_element(nums);
 *

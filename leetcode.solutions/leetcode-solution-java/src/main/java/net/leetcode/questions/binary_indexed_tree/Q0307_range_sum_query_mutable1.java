 ...
 * @author liwei
 */
public class Q0307_range_sum_query_mutable1 {

    private int[] tree;
    private int len;

    public Q0307_range_sum_query_mutable1(int[] nums) {
        len = nums.length;
        tree = new int[2 * len];
        // tree[0] 不使用
        // 给线段树的叶子结点赋值
    ...
    public static void main(String[] args) {
        ...
        net.leetcode.questions.dynamic_programming.NumArray2
            numArray2 = new net.leetcode.questions.dynamic_programming.NumArray2(nums);

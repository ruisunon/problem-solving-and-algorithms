...
class Q0284_peeking_iterator implements Iterator<Integer> {
    ...
    public Q0284_peeking_iterator(Iterator<Integer> iterator) {
    ...
    public static void main(String[] args) {
        ...
        Q0284_peeking_iterator peekingIterator = new Q0284_peeking_iterator(iterator);

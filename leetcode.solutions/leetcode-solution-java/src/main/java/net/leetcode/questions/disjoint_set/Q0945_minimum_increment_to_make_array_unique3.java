...
public class Q0945_minimum_increment_to_make_array_unique3 {
    ...
    public static void main(String[] args) {
        Q0945_minimum_increment_to_make_array_unique3 solution3 = new Q0945_minimum_increment_to_make_array_unique3();
        // int[] A = new int[]{1, 2, 2};

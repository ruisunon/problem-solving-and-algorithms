 ...
 *
 * <p>Q0169_majority_element: O(N). Maintain a stack, for every node which you pop from stack add it to result
 * list, push left and right node to stack. Reverse the result list and return this as the answer.
 */
public class Q0145_binary_tree_postorder_traversal2 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    List<Integer> result = new Q0145_binary_tree_postorder_traversal2().postorderTraversal(root);

 ...
 */
public class Q0911_online_election_TopVotedCandidate {
    ...
    public Q0911_online_election_TopVotedCandidate(int[] persons, int[] times) {
    ...
    public static void main(String[] args) {
        ...
        Q0911_online_election_TopVotedCandidate obj = new Q0911_online_election_TopVotedCandidate(persons, times);

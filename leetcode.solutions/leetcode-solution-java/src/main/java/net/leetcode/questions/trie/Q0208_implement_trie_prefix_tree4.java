...
public class Q0208_implement_trie_prefix_tree4 {
     ...
     */
    public Q0208_implement_trie_prefix_tree4() {
        // 根节点不表示任何字符
        root = new Node();
    }
    ...
    public static void main(String[] args) {
        Q0208_implement_trie_prefix_tree trie = new Q0208_implement_trie_prefix_tree();
        trie.insert("apple");

package net.leetcode.questions.depth_first_search;
 ...
 *
 * <p>Q0169_majority_element: O(N x N) Do a multi-sources BFS starting from each of the water cell and end as soon

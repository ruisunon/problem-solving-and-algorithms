 ...
 * round's points.
 * "D" (one round's score): Represents that the points you get in this round are the doubled data of the last
...
public class Q682_BaseballGame {
    ...
    public int calPoints(String[] ops) {
        ...
        for (String op : ops) {
            ...
            switch (op) {
                case "+":
                    curr = points.peek() + points.get(points.size() - 2);
                    points.push(curr);
                    break;
                case "D":
                    curr = points.peek() * 2;
    ...
    public DataExpectation example1 = DataExpectation
            .create(new String[]{"5", "2", "C", "D", "+"})
            .expect(30);

    @TestData
    public DataExpectation example2 = DataExpectation
            .create(new String[]{"5", "-2", "4", "C", "D", "9", "+", "+"})
            .expect(27);

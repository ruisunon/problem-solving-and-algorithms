...
public class Q392_IsSubsequence {
    ...
    @TestData
    public DataExpectation example1 = DataExpectation.createWith("abc", "ahbgdc").expect(true);

    @TestData
    public DataExpectation example2 = DataExpectation.createWith("axc", "ahbgdc").expect(false);

    @TestData
    public DataExpectation border = DataExpectation.createWith("", "ahbgdc").expect(true);

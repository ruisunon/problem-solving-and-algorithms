...
public class Q715_RangeModule {
    ...
    private static class RangeModule {
        ...
        public void addRange(int left, int right) {
            Entry<Integer, Integer> floor = map.floorEntry(left);
            ...
            Entry<Integer, Integer> entry = map.ceilingEntry(left);

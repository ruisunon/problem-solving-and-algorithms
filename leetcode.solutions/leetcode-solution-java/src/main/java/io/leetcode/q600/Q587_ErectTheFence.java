...
public class Q587_ErectTheFence {
    ...
    /**
     * 这题没有思路, 但其实就是凸包问题, Q0169_majority_element 中给出的几种解答如下, 其中都有图解和动画
     * 另参考资料 (这里还给出了一些其他方法)
     ...
     * 4. 分治法.
     *
     * 与上面 Monotone Chain方法类似, 按照坐标轴的顺序排列(先x 后y), 那么第一个和最后一个点肯定是在边界上的,
     * 同Monotone Chain, 遍历2次, 找出上边界和下边界, 不同在于遍历的方式:

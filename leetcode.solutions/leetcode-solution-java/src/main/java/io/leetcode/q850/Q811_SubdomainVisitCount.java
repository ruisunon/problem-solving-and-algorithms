...
public class Q811_SubdomainVisitCount {
    ...
    public List<String> subdomainVisits(String[] cpdomains) {
        ...
        List<String> res = new ArrayList<>(counts.size());
    ...
    public DataExpectation example1 = DataExpectation.builder()
            .addArgument(new String[]{"9001 discuss.leetcode.com"})
            .expect(Arrays.asList("9001 discuss.leetcode.com", "9001 leetcode.com", "9001 com"))
            .unorderResult("")
            .build();

    @TestData
    public DataExpectation example2 = DataExpectation.builder()
            .addArgument(new String[]{"900 google.mail.com", "50 yahoo.com", "1 intel.mail.com", "5 wiki.org"})
            .expect(Arrays.asList("901 mail.com", "50 yahoo.com", "900 google.mail.com", "5 wiki.org", "5 org",

package algorithms.advanced.sorting;
...
public class MergeKSortedArray {
	...
	public static List<Integer> mergeSortedArrays(List<List<Integer>> sortedArrays) {
		 ...
		 * 
		 * Step 1.) Get the minimum item from the heap Step 2.) Add the ArrayEntry's
		 * value to the result array Step 3.) If the ejected entry has a next value, add
		 * that next item as an annotated ArrayEntry object
		 * 
		 * And iteration continues...
		 * 
		 * When the min heap is entry we will have processed all items in every array
		 * and have a full sorted result
		 */

/**
 * Most of the time when you use an array it's to place integers 
 * inside of it, so why not have a super fast integer only array?
 ...
 **/
package com.rygrids.datastructures.dynamicarray;

package com.rygrids.datastructures.hashtable;

import static org.junit.Assert.*;
import org.junit.*;

import com.rygrids.datastructures.hashtable.DoubleHashingTestObject;
import com.rygrids.datastructures.hashtable.HashTableDoubleHashing;
...
public class HashTableDoubleHashingTest {
  ...
  public void testIterator() {
    ...
    HashTableDoubleHashing <DoubleHashingTestObject, DoubleHashingTestObject> mmap = new HashTableDoubleHashing<>();
  ...
  public void removeTest() {
    ...
    // Add three elements
    map.put(o11, 0); map.put(o12, 0); map.put(o13, 0);
    ...
    // remove three
    map.remove(o11); map.remove(o12); map.remove(o13);
  ...
  public void randomIteratorTests() {
    ...
    HashTableDoubleHashing <DoubleHashingTestObject, LinkedList<Integer>> m = new HashTableDoubleHashing<>();
